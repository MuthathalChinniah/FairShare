...
class LoginForm:
    def __init__(self, window):
        ...
        self.username_label = Label(self.ign_frame, text="Mobile Number", bg="#040405", font=("yu gothic ui", 15, "bold"), fg="#4f4e4d")
        self.username_label.place(x=400, y=190)

        self.username_entry = Entry(self.ign_frame, highlightthickness=0, relief=FLAT, bg="#040405", fg="#666669", font=("yu gothic ui", 12, "bold"))
        self.username_entry.place(x=325, y=220, width=270)

        self.username_line = Canvas(self.ign_frame, width=300, height=2.0, bg="#bdb9b1", highlightthickness=0)
        self.username_line.place(x=325, y=240)
    ...
    def validate_login(self):
        ...
        if username == "testuser" and password == "testpass":  # Replace with actual user verification logic
